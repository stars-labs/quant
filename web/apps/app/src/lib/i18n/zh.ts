...
export default {
	...
	'record.kpi.hold': '同期买入持有',
	'record.kpi.holdSub': '{ret},一直拿着不动',
	'record.kpi.trades': '已完成交易',
	'record.kpi.tradesSub': '另有 {n} 笔持仓中',
	'record.kpi.tradesSubNone': '当前没有持仓',
	'record.kpi.winRate': '胜率',
	'record.kpi.winRateSub': '{n} 笔中 {w} 笔赚钱',
	'record.kpi.best': '最大单笔盈利',
	...
	'record.card.bought': '买入价',
	'record.card.boughtAt': '{ts} UTC 买入',
	'record.card.last': '最新收盘',
	'record.card.openRet': '浮动盈亏(已扣费)',
	'record.card.exitLine': '离场线',
	'record.card.exitHint': '1 小时收盘价跌破离场线就卖出。',
	'record.card.trigger': '买入触发价',
	'record.card.triggerHint': '1 小时收盘价突破触发价就买入。',
	'record.card.fromLast': '距现价 {pct}',
	'record.card.since': '{start} 起',
	'record.card.strategy': '策略',
	'record.card.hold': '买入持有',
	'record.card.stats': '{n} 笔已完成 · {w} 笔赚钱',
	'record.card.avg': '平均盈利 {win} · 平均亏损 {loss}',
	'record.src.live': '实时',
	'record.src.backfill': '回溯',
	'record.src.liveHint': '信号出现时实时记录',
	'record.src.backfillHint': '事后用同一规则在历史行情上重放算出,不是当时发出的信号',
	'record.cta.title': '下一个信号,第一时间推给你',
	'record.cta.sub':
		'绑定 Telegram 并勾选「策略买卖信号」:买入、离场和每周战绩都会推送,每条都附带离场规则。',
	'record.trades.title': '全部交易记录',
	'record.trades.sub': '共 {n} 笔,最新在前。时间为 UTC,收益已扣手续费。',
	'record.col.asset': '币种',
	'record.col.entry': '买入',
	'record.col.exit': '卖出',
	'record.col.ret': '收益',
	'record.col.days': '持有',
	'record.col.source': '来源',
	'record.trades.holding': '持有中',
	'record.trades.floating': '浮动',
	'record.trades.days': '{n} 天',
	'record.trades.showAll': '显示全部 {n} 笔',
	'record.trades.showLess': '收起',
	'record.trades.empty': '还没有交易记录。',
	'record.rules.title': '规则怎么运作',
	'record.rules.buy': '买入:1 小时 K 线收盘价高于过去 7 天(168 根 1 小时 K 线)的最高价。',
	...
	'record.honest.body':
		'趋势信号大多会小亏离场,赚钱靠少数几段大行情。只挑几笔跟,很可能恰好错过赚钱的那一笔;行情横盘时会连续小亏,也可能跑输买入持有。',
	'record.honest.stats':
		'{start} 以来,{n} 笔已完成交易中 {w} 笔赚钱(胜率 {rate}),最大一笔是 {asset} {best}。',
	'record.backfill.title': '「回溯」是什么',
	'record.backfill.body':
		'标「回溯」的交易是事后用同一条规则在历史行情上重放算出来的,不是当时发出的实时信号。',
	'record.backfill.since': '{since} 起的新信号标「实时」:每小时收盘后立即记录,并推送给订阅者。',
	'record.disclaimer':
		'规则模拟信号,不构成投资建议。我们不代客理财,也不提供仓位建议;过往表现不代表未来收益。',
	'record.empty.title': '战绩正在准备中',
	'record.empty.body': '历史回溯还没完成,完成后这里会列出每一笔交易。',
	'record.error.title': '战绩暂时加载不出来',
	'record.error.body': '数据服务暂时无法访问,请稍后刷新页面。',

	// --- nautilus (execution engine) ---
	'nautilus.superseded': '已被替代',
